...
/***/ function(module, exports, __webpack_require__) {
	...
	yiel.super_scraper = new _main2.default();
	...
	describe('scrape', function () {
		describe('image', function () {
			it('should scrape the src from an img tag', function () {
				var res = yiel.super_scraper.scrape.image('.product-image > img');
				expect(res).equal('http://dwmvwp56lzq5t.cloudfront.net/johnvu_files/super_scraper/product.jpg');
			});
			it('should scrape the background url from a div or span tag', function () {
				var res = yiel.super_scraper.scrape.image('#starRating');
				expect(res).equal('http://dwmvwp56lzq5t.cloudfront.net/johnvu_files/super_scraper/stars.jpg');
			});
		});

		describe('text', function () {
			it('should scrape the text from an element', function () {
				var res = yiel.super_scraper.scrape.text('#productName');
				expect(res).equal('Purple Blouse');
			});
			it('should scrape the value from a select field', function () {
				var res = yiel.super_scraper.scrape.text('#productQty');
				expect(res).equal('1');
			});
			it('should scrape the value from an input field', function () {
				var res = yiel.super_scraper.scrape.text('#hiddenInput');
				expect(res).equal('SaleItem');
			});
		});

		describe('link', function () {
			it('should scrape the href from an archor element', function () {
				var res = yiel.super_scraper.scrape.link('.breadcrumb a');
				expect(res).equal('womens.html');
			});
		});
		describe('cart', function () {
			it('should ajax the cart page and return a DOM object', function (done) {
				yiel.super_scraper.scrape.cart('cart.html').then(function (dom) {
					var res = dom;
					expect(res.length).gt(0);
					done();
				});
			});
			it('should return a DOM object that can be executed on with jQuery', function (done) {
				yiel.super_scraper.scrape.cart('cart.html').then(function (dom) {
					var res = yiel.super_scraper.scrape.text('#total', dom);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _super_scraper = __webpack_require__(2);

	var _super_scraper2 = _interopRequireDefault(_super_scraper);
	...
	exports.default = _super_scraper2.default; /*
	                                           import Super_Scraper from './main-core.js';
	                                           
	                                           export default Super_Scraper;
	                                           */
...
/***/ function(module, exports, __webpack_require__) {
	...
	_super_scraper2.default.prototype.scrape = _super_scraper2.default.prototype.scrape || {};
	var scrape_image = _super_scraper2.default.prototype.scrape.image = function (element) {

		var element = yiel.$(element);
		var imageSrc, backgroundProp, backgroundUrl, regex;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_super_scraper2.default.prototype.scrape = _super_scraper2.default.prototype.scrape || {};
	var scrape_text = _super_scraper2.default.prototype.scrape.text = function (selector, dom) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	_super_scraper2.default.prototype.scrape = _super_scraper2.default.prototype.scrape || {};
	var scrape_link = _super_scraper2.default.prototype.scrape.link = function (element) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	_super_scraper2.default.prototype.scrape = _super_scraper2.default.prototype.scrape || {};
	var scrape_cart = _super_scraper2.default.prototype.scrape.cart = function (url) {

		return new _promise2.default(function (resolve, reject) {
			var dom;
			var ajax = yiel.$.get(url).then(function (data) {
